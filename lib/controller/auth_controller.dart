...
import 'package:socialmedia/services/authentication_services.dart';
...
class AuthenticationController extends GetxController {
  ...
  Future signIn() async{
    ...
    SharedPreferences pref = await SharedPreferences.getInstance();
      ...
      try {
        var response = await http.post(Uri.parse('https://abhinavsocialmedia.herokuapp.com/api/v1/user/thirdPartyLogin'),
          body: body,
        );
